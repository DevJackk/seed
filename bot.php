...
if(!file_exists('config.json')){
	$token = '1632284344:AAEfIAOjL9wr3aE66p326T4yt0xBw5hffvQ';
	$id = '1730972299';
...
try {
			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/Gonfgat_AHMED/2945",
                   'caption'=>'𝑤𝑒𝑙𝑐𝑜𝑚𝑒 𝑡ℎ𝑒 𝑡𝑜𝑜𝑙 𝑏𝑦 ࿇࿆(@lllIIIlIlIIIIIlllll)  🛃',
    ...
    if($text == '/help'){
              ...
              'caption'=>'طرق السحب',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"اضغط لمراسله المطور للابلاغ عن مشاكل ", 'url'=>"https://t.me/V_P_E"]],
                       ]
                       ])
                       ]);
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 『 𓆰⌯Saber』','url'=>'t.me/V_P_E']],
                          [['text'=>"▪️| 𓆰⌯CH⌯🇦🇪", 'url'=>"t.me/V_P_E"]],
                      ]
                  ])
              ]);   
				}
